...
const PlanoRow = memo(function PlanoRow({
  ...
  return (
    <tr className={cn('technical-grid-row', sintetica && 'bg-amber-50/50')}>
      ...
      <td
        className={cn(
          'px-3 py-2 border-r border-brand-border/10 italic text-brand-text whitespace-normal break-words align-top',
          planoNivelIndentClass(nivel),
