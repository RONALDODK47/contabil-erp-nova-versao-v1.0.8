      ...
      {activeSection === 'config' && (
        <>
          <section className="technical-panel p-4 space-y-3 shadow-[2px_2px_0_0_#141414]">
            ...
            <p className="text-[10px] font-black uppercase tracking-wide text-orange-900 bg-orange-50 border border-orange-700 px-3 py-2">
              {EXTRACT_ENGINE_LABELS.ai}
            </p>
            <p className="text-[9px] opacity-60 leading-relaxed">
              Envia a imagem do extrato ao modelo na nuvem (precisa de chave API). Extratos PDF usam o
              leitor-recortador (sem OCR local). Só aparecem modelos com visão capazes de extrato e
              conciliação.
            </p>
          </section>
